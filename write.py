...
def write_learners():
    ...
    learner_pascual = Learner(first_name='Pascual',last_name='Flores',dob=date(2000,5,18),occupation='developer',social_link='https://www.linkedin.com/pascual-flores/')
    learner_pascual.save()
